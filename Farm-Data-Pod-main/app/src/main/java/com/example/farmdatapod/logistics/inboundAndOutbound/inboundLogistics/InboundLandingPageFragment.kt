package com.example.farmdatapod.logistics.inboundAndOutbound.inboundLogistics
...
class InboundLandingPageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_inbound_landing_page, container, false)
    }
    ...
    private fun setupRecyclerView() {
        val options = listOf(
            ...
            HomepageOption(
                title = "Loading",
                iconResId = R.drawable.producer // Make sure you have this icon in your drawable resources
            )
        )

        adapter = HomepageOptionsAdapter(options) { option ->
            when (option.title) {
                "Offloading" -> findNavController().navigate(
                    R.id.action_inboundLandingPageFragment_to_offloadingFragment
                )
                "Loading" -> findNavController().navigate(
                    R.id.action_inboundLandingPageFragment_to_loadingFragment
                )
            }
        }
