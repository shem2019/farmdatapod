...
class CropManagementActivityViewModel(application: Application) : AndroidViewModel(application) {
    private val repository: CropManagementActivityRepository = CropManagementActivityRepository(application)
