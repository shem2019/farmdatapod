...
class CropNutritionManagementViewModel(application: Application) : AndroidViewModel(application) {
    private val TAG = "CropNutritionManagementViewModel"
    private val repository = CropNutritionManagementRepository(application)
