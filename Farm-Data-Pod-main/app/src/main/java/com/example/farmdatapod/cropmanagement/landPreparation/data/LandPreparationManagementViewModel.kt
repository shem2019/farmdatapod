...
class LandPreparationManagementViewModel(application: Application) : AndroidViewModel(application) {
    private val repository = LandPreparationManagementRepository(application)
