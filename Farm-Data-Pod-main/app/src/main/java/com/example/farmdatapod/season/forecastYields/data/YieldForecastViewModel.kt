...
class YieldForecastViewModel(private val repository: YieldForecastRepository) : ViewModel() {
    ...
    // Factory as companion object

        class Factory(private val context: Context) : ViewModelProvider.Factory {
            @Suppress("UNCHECKED_CAST")
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                if (modelClass.isAssignableFrom(YieldForecastViewModel::class.java)) {
                    return YieldForecastViewModel(YieldForecastRepository(context)) as T
                }
