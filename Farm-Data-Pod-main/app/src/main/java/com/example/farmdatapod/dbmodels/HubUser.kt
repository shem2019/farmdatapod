...
class HubUser {
    ...
    constructor(
        id: Int, other_name: String?, last_name: String?, code: String?, role: String?,
        id_number: String?, gender: String?, date_of_birth: String?, email: String?,
        phone_number: String?, education_level: String?, hub: String?, buying_center: String?,
        county: String?, sub_county: String?, ward: String?, village: String?, is_offline: Int,
        user_id: String?,
    ) {
        this.id = id
