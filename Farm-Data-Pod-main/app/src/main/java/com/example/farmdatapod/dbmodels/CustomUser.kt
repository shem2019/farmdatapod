...
class CustomUser {
    ...
    var is_offline: Int = 0  // Corrected field name
    ...
    constructor(
        id: Int, other_name: String?, last_name: String?, staff_code: String?, id_number: String?,
        gender: String?, date_of_birth: String?, email: String?, phone_number: String?,
        education_level: String?, role: String?, reporting_to: String?, is_offline: Int, user_id: String?
    ) {
        this.id = id
